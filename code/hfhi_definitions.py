...
DEFINITIONS = {
    "Housing in general": "explicitly describes provision of housing/shelter, development of housing/shelter, improving access to housing/shelter, or housing/shelter policies. It includes housing technical assistance, housing capacity building, and legal advice on housing, land and property rights. It may also include smart, green, or energy-efficient housing solutions. The housing must be intended for people to live in; whether temporary or permanent, private or collective. This class excludes general infrastructure, construction, or renovations unless they clearly serve a residential housing function, as well as urban development projects that do not specifically address housing.",
    "Homelessness": "explicitly describes experiences, conditions, services, or interventions related to people lacking stable housing. It includes unsheltered and hidden homelessness, temporary accommodations like shelters, dormitories, or safe houses, and long-term solutions like Housing First and supportive housing. It may also include programs addressing the housing needs of displaced or marginalized populations when the lack of stable housing is central. It excludes generic poverty relief or emergency aid unless explicitly connected to housing instability or homelessness.",
    ...
    "Urban": "explicitly describes activities in specific urban locations. The activity must occur in an urban setting but is not necessarily related to housing unless other definitions apply. Do not classify urban development as 'Housing in general' unless housing is explicitly involved.",
