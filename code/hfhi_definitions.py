...
DEFINITIONS = {
    "Housing in general": "explicitly describes activities related to the provision, development or policy of residential shelter. It covers shelter and dwelling construction, urban and rural housing projects, and design of inclusive or collective living quarters. It includes technical assistance, capacity building, and legal advice on housing, land and property rights. It addresses policy frameworks, public-private partnerships, and smart, green or energy-efficient housing solutions. It also encompasses measures to improve housing access and reduce residential emissions through carbon-neutral design.",
    "Homelessness": "explicitly describes experiences, conditions, services or interventions related to people lacking stable housing. It includes unsheltered populations in tent cities, homeless encampments, street homelessness and hidden homelessness. It covers temporary, transitional and supportive accommodations such as shelters, dormitories, safe houses and Housing First programs. It also encompasses permanent supportive housing, housing vouchers and other shelter and support programs. It addresses statutory, chronic, indigenous, sheltered, unsheltered, absolute and relative homelessness.",
